  ...
  return (
    <div className='salesListContainer'>
        ...
        {buttonslist.map((list)=>(
           <button className='activebtn'><NavLink exact to={list.link} className={window.location.pathname === list.link ? 'activee' : 'btnnn'}><span>{list.icon}</span>{list.name}</NavLink></button>
            ...
            {/* <div className='navigatebtn'>
                <button><span><IoCube /></span> To Review</button>
                <button><span><FaCopy /></span> ShortListed</button>
            </div> */}
            <div className='lists'>
               <ReviewList />
            </div>
